...
public class FormulaSelectionEngine implements ISelectionEngine {

	/* (non-Javadoc)
	 * @see org.eclipse.dltk.codeassist.ISelectionEngine#select(org.eclipse.dltk.compiler.env.IModuleSource, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.dltk.codeassist.ISelectionEngine#setOptions(java.util.Map)
	 */
	@Override
